"""Q147. Store "name" of a student as key, "list of
5 marks" of that student as a value. Store atleast 5
student names. Print the sum and precentage of all the sutdents."""
